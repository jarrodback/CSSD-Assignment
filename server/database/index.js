...
const journey = require("../models/journey.model.js")(mongoose);
const bill = require("../models/bill.model.js")(mongoose);
const location = require("../models/location.model.js")(mongoose);
